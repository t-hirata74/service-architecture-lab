...
> 🔴 設計フェーズの文書。実装の進行に合わせて「実装ポインタ」「学びログ」を追記していく。
...
| backend (NestJS) | 3140 | `npm run start:dev` (Phase 2〜) |
| frontend (Next.js) | 3145 | `npm run dev` (Phase 5〜) |
| ai-worker (FastAPI) | 8130 | compose で有効化 (Phase 4〜) |
