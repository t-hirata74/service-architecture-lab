...
variable "frontend_image" {
  type    = string
  default = "ghcr.io/example/linear-frontend:latest"
}

variable "backend_image" {
  type    = string
  default = "ghcr.io/example/linear-backend:latest"
}

variable "ai_worker_image" {
  type    = string
  default = "ghcr.io/example/linear-ai-worker:latest"
}
