...
resource "aws_secretsmanager_secret" "database_url" {
  name        = "discord/database_url"
  description = "MySQL DSN for Go gateway"
}
...
resource "aws_secretsmanager_secret" "ai_internal_token" {
  name        = "discord/ai_internal_token"
  description = "Shared secret between Go gateway and ai-worker (X-Internal-Token)"
}
