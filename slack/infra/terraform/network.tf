...
resource "aws_subnet" "public" {
  ...
  tags = {
    Name = "slack-public-${var.azs[count.index]}"
    Tier = "public"
  }
}
...
resource "aws_subnet" "private_app" {
  ...
  tags = {
    Name = "slack-private-app-${var.azs[count.index]}"
    Tier = "app"
  }
}
...
resource "aws_subnet" "private_data" {
  ...
  tags = {
    Name = "slack-private-data-${var.azs[count.index]}"
    Tier = "data"
  }
}
...
resource "aws_eip" "nat" {
  count  = length(var.azs)
  domain = "vpc"
  tags   = { Name = "slack-nat-${var.azs[count.index]}" }
}
...
resource "aws_route_table" "private" {
  ...
  tags = { Name = "slack-private-rt-${var.azs[count.index]}" }
}
