...
variable "frontend_image" {
  type    = string
  default = "ghcr.io/example/uber-frontend:latest"
}

variable "backend_image" {
  type    = string
  default = "ghcr.io/example/uber-backend:latest"
}

variable "ai_worker_image" {
  type    = string
  default = "ghcr.io/example/uber-ai-worker:latest"
}
