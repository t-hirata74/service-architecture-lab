...
| Backend (Rails 8 + GraphQL) | ⚪ Phase 2 未着手 |
| Frontend (Next.js + urql)   | ⚪ Phase 2 未着手 |
...
| Phase | 範囲 | 成果物 |
| --- | --- | --- |
| 1 | 雛形 + ADR + architecture.md + docker-compose | 🟡 進行中 |
| 2 | Org / Team / User / Repository + PermissionResolver + GraphQL `viewer` / `repository` | ⚪ |
