...
class RodauthMain < Rodauth::Rails::Auth
  configure do
    ...
    # 認証は JWT (ADR 0004) を採用するため :remember (cookie 方式) は無効。
    # email 依存機能 (verify_account / reset_password など) はメール基盤整備後に有効化。
    ...
    # hmac_secret "70d56a92fdea2fdb931517b61760a69b08c2b9a2530451aec10c76fa681c6dabc69cfd53b82de35b7105726b520fd7832981b12243bf14e706ea634f8671fa85"
