...
| --- | --- | --- |
| **Rails** | slack / youtube / github / perplexity / shopify / zoom | WebSocket fan-out / 状態機械 / 権限グラフ / SSE + RAG / **モジュラーモノリス + multi-tenant + webhook 配信** / **長寿命 state machine + 動的権限譲渡 + 結果 UNIQUE 冪等パイプライン** |
