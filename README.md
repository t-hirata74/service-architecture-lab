...
| [`linear`](linear/README.md#e2e-デモ-playwright-で録画) | 2 | **Device A \| B を hstack** — ①issue 作成/移動の realtime fan-out (楽観 → GEN-1 確定 → WS push) ②**オフライン編集 → 復帰 replay** (保存中バッジ → 冪等再送 → 他デバイスへ反映) |
