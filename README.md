...
| [`github`](github/) | GitHub 風 Issue Tracker | 権限グラフ / Issue・PR モデル / CI ステータス集約 / GraphQL field 認可 | 🟡 Phase 4 完了 (PullRequest + Review + 番号空間共有 + 8 mutation / RSpec 51 件) | [README](github/README.md) ・ [Architecture](github/docs/architecture.md) ・ [ADR (4)](github/docs/adr/) |
