...
| [`instagram`](instagram/) | Instagram 風タイムライン (Django/DRF) | タイムライン生成戦略 (fan-out on write) / フォローグラフ DB 設計 / Django ORM N+1 + index / DRF TokenAuthentication | 🟢 Phase 5 完了 (Django pytest 48 + ai-worker pytest 8 / Playwright scaffold / Terraform validate pass / CI 4 ジョブ追加) | [README](instagram/README.md) ・ [Architecture](instagram/docs/architecture.md) ・ [ADR (4)](instagram/docs/adr/) |
