...
| [`discord`](discord/) | Discord 風リアルタイムチャット (Go) | ギルド単位シャーディング + 単一プロセス Hub / goroutine + channel CSP pattern / プレゼンスハートビート / WebSocket fan-out (slack Rails ActionCable との対比) | 🟡 Phase 1 設計完了 (ADR 4 本 / architecture.md / docker-compose) | [README](discord/README.md) ・ [Architecture](discord/docs/architecture.md) ・ [ADR (4)](discord/docs/adr/) |
...
| **Go** | discord (Phase 1 設計完了) | WebSocket fan-out / ギルド単位シャーディング / プレゼンス整合性 |
...
service-architecture-lab/
  ...
  discord/                # Discord 風 (Go / Phase 1 設計完了)
  docs/                   # 共通ルール (走りながら整備)
