...
- **[docs/api-style.md](docs/api-style.md)** — REST/GraphQL 選定軸 + GraphQL 運用ルール / **subdomain 解決 middleware (shopify)** / **3rd-party App API: Bearer token + scope 認可 (shopify)**
