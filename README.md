...
| [`instagram`](instagram/) | Instagram 風タイムライン (Django/DRF) | タイムライン生成戦略 (fan-out on write) / フォローグラフ DB 設計 / Django ORM N+1 + index / DRF TokenAuthentication | 🟡 Phase 4 完了 (ai-worker /recommend /tags + Next.js 16 frontend / Django pytest 44 + ai-worker pytest 8 / E2E + CI + Terraform は Phase 5) | [README](instagram/README.md) ・ [Architecture](instagram/docs/architecture.md) ・ [ADR (4)](instagram/docs/adr/) |
...
service-architecture-lab/
  ...
  instagram/              # Instagram 風 (Django/DRF / Phase 1 設計完了)
  docs/                   # 共通ルール (走りながら整備)
