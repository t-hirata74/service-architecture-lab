...
| [`instagram`](instagram/) | Instagram 風タイムライン (Django/DRF) | タイムライン生成戦略 (fan-out on write) / フォローグラフ DB 設計 / Django ORM N+1 + index / DRF TokenAuthentication | 🟡 Phase 1 設計完了 (ADR 4 本 / architecture.md / docker-compose) | [README](instagram/README.md) ・ [Architecture](instagram/docs/architecture.md) ・ [ADR (4)](instagram/docs/adr/) |
