  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "DB_USER", value = "figma_admin" },
        { name = "AI_WORKER_URL", value = "http://ai-worker.figma.local:8110" },
  ...
  container_definitions = jsonencode([
    {
      ...
      essential    = true
      portMappings = [{ containerPort = 3125 }]
      environment = [
  ...
  container_definitions = jsonencode([
    {
      ...
      essential    = true
      portMappings = [{ containerPort = 8110 }]
      secrets = [
