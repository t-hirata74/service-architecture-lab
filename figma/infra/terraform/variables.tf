...
variable "backend_image" {
  type    = string
  default = "ghcr.io/example/figma-backend:latest"
}

variable "frontend_image" {
  type    = string
  default = "ghcr.io/example/figma-frontend:latest"
}

variable "ai_worker_image" {
  type    = string
  default = "ghcr.io/example/figma-ai-worker:latest"
}
